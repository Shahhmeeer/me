  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
         ...
         * never handed a dead button. The third script on the page, after
         * the reveal's and the Strip's, is Cloudflare's, loaded by the
         * Turnstile widget in components/turnstile.tsx only where the Form
         * is and only when there is a site key; with JavaScript off it never
         * loads, the Form posts with no Token, and the route's page is the
         * answer.
         */}
        <noscript
